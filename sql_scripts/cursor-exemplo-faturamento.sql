DECLARE
   --CURSOR DECLARATION
  TYPE P_ARRAY_NUM_ALT_ENTREGA IS VARRAY(5) OF AUTORIZACAO_ENTREGA.NUM_AUTORIZACAO_ENTREGA%TYPE;
  ARRAY P_ARRAY_NUM_ALT_ENTREGA := P_ARRAY_NUM_ALT_ENTREGA(20787,20788,20789,20791);
  
  CURSOR C_CANCELAAF ( --P_NUM_AUTORIZACAO_ENTREGA AUTORIZACAO_ENTREGA.NUM_AUTORIZACAO_ENTREGA%TYPE
                      -- TYPE P_ARRAY_NUM_ALT_ENTREGA IS VARRAY(4) OF NUMBER
                       ARRAY P_ARRAY_NUM_ALT_ENTREGA
     ...
     ------- SELECT 
      ...
      WHERE 1 = 1
      AND AES.NUM_AUTORIZACAO_ENTREGA IN (P_NUM_AUTORIZACAO_ENTREGA)
...
BEGIN 
  ---------------------------------
   --OPEN CURSOR 
   OPEN C_CANCELAAF( P_ARRAY_NUM_ALT_ENTREGA(20787,20788,20789,20791), 2021, 2);
