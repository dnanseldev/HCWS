SELECT DISTINCT OS.NUM_ORDEM,
                ...
                OS.DTA_HOR_FINALIZACAO    DTA_OCORRENCIA,
 ...
 WHERE OS.DTA_HOR_FINALIZACAO BETWEEN TO_DATE('01/01/2015', 'DD/MM/YYYY') AND
...
-- Numero de Minutos trabalhados
 ...
 WHERE AA.DTA_HOR_INICIO_ATIVIDADE BETWEEN TO_DATE('01/01/2015', 'DD/MM/YYYY') AND  TO_DATE('31/12/2020', 'DD/MM/YYYY')      
...
-- Oficinas
      SELECT Z.*, Y.NOM_INSTITUTO
       FROM (SELECT UE.COD_UNIDADE_EXECUTANTE_PAI,                   
                    ...
                    RTRIM(XMLAGG(XMLELEMENT(E, UE.COD_UNIDADE_EXECUTANTE||'-'|| UE.NOM_UNIDADE_EXECUTANTE, ',' || CHR(13)).EXTRACT('//text()') ORDER BY UE.NOM_UNIDADE_EXECUTANTE)
                          .GETCLOBVAL(),  ',') OFICINAS,
                          COUNT(*) QTD
...
6-APOIO ADMINISTRATIVO - CEC,
11-CEMB - UE,
70-CONTROLE DA QUALIDADE,
5-COORDENADORIA,
8-ELETROMÉDICOS,
22-GERÊNCIA DE ENGENHARIA CLÍNICA,
9-OFICINA DE PRECISÃO,
7-SUPRIMENTOS / ALMOXARIFADO - CEC,

2,5,6,7,8,9,11,22,70
