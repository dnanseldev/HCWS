...
DECLARE
  ...
  CURSOR C_CANCELAAF --( P_NUM_AUTORIZACAO_ENTREGA AUTORIZACAO_ENTREGA.NUM_AUTORIZACAO_ENTREGA%TYPE
                      ...
                      --,P_COD_INSTITUICAO AUTORIZACAO_ENTREGA.COD_INSTITUICAO%TYPE )
      IS     
      ...
      WHERE 1 = 1
      AND AES.NUM_AUTORIZACAO_ENTREGA IN (23938, 31773, 31830, 32426)
      AND AES.ANO_AUTORIZACAO_ENTREGA = 2015
      AND AES.COD_INSTITUICAO = 2;                  
